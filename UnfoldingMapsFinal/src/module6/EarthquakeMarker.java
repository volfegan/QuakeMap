...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker> {
	...
	/*
	Comparable interface in EarthquakeMarker:
	- add the keywords “implements Comparable<EarthquakeMarker>” to the class definition.
	After you change the header, but before you do step b, make a note of what error(s) occur in your code,
	where they occurred and why. We’ll ask you about this on the quiz.
	-> OceanQuakeMarker and LandQuakeMarker are not abstract and does not override abstract method compareTo(module6.EarthquakeMarker) in java.lang.Comparable
